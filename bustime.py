...
def bus(stop):
    response = requests.get(f"https://bustime.mta.info/api/2/siri/stop-monitoring.json?key=3f6c967c-b46d-4e88-b0b7-4d35e00b8c77&MTA&MonitoringRef={stop}&MaximumStopVisits=100")
    data = response.json()
    return {
